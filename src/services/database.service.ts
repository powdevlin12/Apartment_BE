...
import UserApartment from '~/models/schemas/UserApartment.schema'
dotenv.config()
...
export default class DatabaseConnect {
  ...
  get usersApartments(): Collection<UserApartment> {
    return this.db.collection(process.env.DB_COLLECTION_USERS_APARTMENTS as string)
  }
